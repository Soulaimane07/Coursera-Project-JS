  ...
  return (
    <div className='w-full py-10 px-6 md:px-20'>
        ...
        <div className='flex flex-row justify-between items-center mt-10'>
            <SearchBox placeholder={"Search by email address"} />
        ...
        <div className="relative overflow-x-auto  sm:rounded-lg mt-10">
            {layout === 0 && 
                <div className='flex flex-wrap justify-center space-x-4'>
                    <GridTeachers teachers={teachers} lang={lang} setDetailsProf={setDetailsProf} setUpdateProf={setUpdateProf} />
                </div>
            }
            {layout === 1 && <TeachersTable teachers={teachers} lang={lang} setDetailsProf={setDetailsProf} setUpdateProf={setUpdateProf} />}
        </div>
