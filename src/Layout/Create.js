        ...
        <div className=" rounded-md bg-white shadow-2xl w-2/6">
            ...
            <div className="px-10 pb-2">
                ...
                <div className="mb-6 flex flex-col">
                    ...
                    <textarea onChange={(e)=> setdesc(e.target.value)} rows="3" class="border-2 rounded-md border-gray-300 outline-none px-3 py-1" placeholder="Write your thoughts here..."></textarea>
                </div>
                <div className="mb-6 flex flex-col">
