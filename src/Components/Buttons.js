...
export const Spinner = () => {
    return(
        <div role="status">
            <svg aria-hidden="true" className="w-6 h-6 text-transparent animate-spin  fill-white" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
