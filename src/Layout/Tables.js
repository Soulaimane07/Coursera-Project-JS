...
export const TeachersTable = ({teachers, lang, setDetailsProf, setUpdateProf, deleteBtn}) => {
                    ...
                    ?   teachers?.map((item,key)=>(
                            <tr key={key} className='hover:bg-blue-100 transition-all border-b-1 border-blue-200 text-gray-700'>
                                ...
                                <td className="">
                                    ...
                                    <button onClick={()=> deleteBtn(item?.id)} className='px-2 opacity-70 hover:opacity-100 transition-all'>
